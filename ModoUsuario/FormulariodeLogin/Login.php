...
<body>
    <?php include ('https://proydweb.com/proyectos/2023/Isha/menu.php'); ?>
    <br>
    <br>
    <br>
    <br>
    ...
    <section class="form_wrap">
        ...
        <center><a  href="../FormularioRegistroNUsuario/index.php"><button class="btn btn-success" align="center">No tienes cuenta Registrate Aqui</button></a></center>
    </section>
