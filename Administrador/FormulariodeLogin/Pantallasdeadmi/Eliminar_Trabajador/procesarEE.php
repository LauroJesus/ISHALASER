...
<?php 	
    ...
    mysqli_query($link, "DELETE FROM empleado WHERE id = '$id'") or die(mysqli_error($link));
...
<center><a href='https://proydweb.com/proyectos/2023/Isha/Administrador/FormulariodeLogin/Pantallasdeadmi/ver_cuentas_E.php'><button class='btn btn-primary'>Volver a paguina inicial</button></a> </center>
</body>
</html>