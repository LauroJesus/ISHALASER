<html>
  ...
  <?php 
    ...
    ?>
    <div class="container">
        <p class="form-titulo">Usted eliminara la cuenta con los siguientes datos</p>

        <form METHOD="POST" ACTION="procesarE.php" name = "enviar_cartel"  enctype="multipart/form-data" class="table table-striped col-sm-12 col-md-4 col-lg col-xl-4">
