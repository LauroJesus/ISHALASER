<html>
  ...
  <?php 
    ...
    ?>
    <div class="container">
        <p class="form-titulo">Usted Modificara la cuenta de EMPLEADO con los siguientes datos</p>

        <form METHOD="POST" ACTION="procesarEmpleado.php" name = "enviar_cartel"  enctype="multipart/form-data" class="table table-striped col-sm-12 col-md-4 col-lg col-xl-4">
            <table class="table table-danger">
               ...
               <tr><td>Correo Electronico:</td><td><input type="text"  name="correo" value="<?php echo $row["correo_electronico"];?>"></td></tr>
            ...
            <input type="submit" value="Modificar"  NAME = "accion"><br><br><br>
          </form>
    </div>
