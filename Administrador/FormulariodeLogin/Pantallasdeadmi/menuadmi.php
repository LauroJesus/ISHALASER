...
<header>
		...
		<h1 style="text-align: center; font-size: 3em;">Bienvenido Administrador</h1>
	</header>
...
Además sus letreros neón son fabricados con materiales de alta calidad y diseñados para ser duraderos y resistentes. También, ofrecemos una gran variedad de colores y tamaños para que pueda elegir el que mejor se adapte a sus necesidades.</p>
      ...
      <?php 
                ...
                <table width='80%' border='0' bordercolor='' align='center' class="table table-condensed">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        for ($j = 0; $j < 1; $j++) {
                            ...
                            echo "<a href='Modificar cartel/formulariomodificar_cartel.php?id=".$row["id"]."'><button class='btn btn-warning'>Modificar</button></a><br><br>";
                            echo "<a href='Eliminar cartel/eliminar.php?id=".$row["id"]."'><button class='btn btn-danger'>Eliminar</button></a><br><br>";
        ...
        <td>
            <center><a href="Agregarcartel/formularioagregar_cartel.php"><button class="btn btn-success" align="center">Agregar Letrero</button></a></center>
