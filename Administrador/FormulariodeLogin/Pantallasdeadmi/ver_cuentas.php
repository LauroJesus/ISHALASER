...
<br>
    <header>
		...
		<h1 style="text-align: center; font-size: 3em;">Cuentas Registradas</h1>
	</header>
        ...
        <div class="" >
                <table width='80%' border='0' bordercolor='' align='center' class="table table-condensed">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<br><b> Cuentas Registradas" . $i . ":</b><br>";
                        for ($j = 0; $j < 1; $j++) {
                            ...
                            echo "<a href='Modificar_Cuernta/formulariomodificar_cuenta.php?id=".$row["id"]."'><button class='btn btn-warning'>Modificar</button></a><br><br>";
                            echo "<a href='Eliminar_Cuenta/eliminar.php?id=".$row["id"]."'><button class='btn btn-danger'>Eliminar</button></a><br><br>";
